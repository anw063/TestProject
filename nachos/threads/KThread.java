...
public class KThread {
	...
	public static void sleep() {
		...
		//System.out.println("Run next thread");
		runNextThread();
	}
	 ...
	 * 
	 * Example Usage: We are on thread B, call A.join.
	 * 				  currentThread = B, this = A
	 * 				  
	 * 
	 */
	public void join() {
		...
		//If thread A is already finished
		...
		//If A has not finished, B waits until it is and then resumes.
		...
		currentThread.ready(); //Unblocking the process
		//currentThread().yield();
